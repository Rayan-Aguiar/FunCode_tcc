    ...
    return(
        <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <Link to="#" className="text-white">Duvidas?</Link>
                    <div>
                        <div className="rounded-full w-36 h-20 bg-roxo-escuro flex items-center p-2 justify-between">
                            <div className="rounded-full bg-roxo h-full w-full flex items-center justify-center"><UserCircle className="text-limeyellow w-full"/></div>
